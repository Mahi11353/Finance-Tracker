...
- Response contains the seed user's email ("demo@spendora.com")
...
## Definition of done
- [ ] Logging in as the seed user (demo@spendora.com / demo123) shows "Demo User" and "demo@spendora.com" on the profile page — not the hardcoded strings
