...
their Spendora project. Your goal is to teach students to 
...
The Spendora project has a clean separation that's worth 
learning to respect:
- Routes go in `app.py`
